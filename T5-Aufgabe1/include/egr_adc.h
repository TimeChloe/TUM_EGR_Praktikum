 ...
 */
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Description: This header file contains the function prototypes for the ADC module.
// Steps to use the ADC module:
// 1. Call the ADC_Init() function to initialize the ADC module.
// 2. Call the ADC_start() function to start the ADC module.
// 3. Call the read_Potentiometer() function to read the potentiometer value.
// 4. Call the read_BrightnessSensor() function to read the brightness sensor values.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#ifndef EGR_ADC_H
#define EGR_ADC_H
...
#define Brightness1_Pin 0
#define Brightness2_Pin 1
#define Brightness3_Pin 7
...
void ADC2_configuration(int length, int mode);
void activate_sensor_gpio(void);
void ADC1_Calibration(void);
void ADC2_Calibration(void);
void ADC_start(int mode);
void ADC1_start(void);
void ADC2_start(int mode);

uint32_t read_Potentiometer(void);
uint32_t *read_BrightnessSensor(uint32_t *results,int length);
